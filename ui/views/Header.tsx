...
const Header: FC = (): ReactNode => {
  return (
    <div className="bg-[#222730] p-[15%] lg:px-[25%] py-16 relative pb-28 items-center mb-12 flex flex-col justify-center">
      <div className="max-w-7xl mx-auto items-center flex flex-col justify-center">
        ...
        <h1 className="mt-4 font-display text-2xl md:text-4xl lg:text-6xl self-center flex font-semibold leading-snug text-primary text-white">
          Stand with Palestine
        </h1>

        <p className="text-md lg:text-xl text-gray-300 mt-1 font-display max-w-lg md:max-w-full py-1 text-center text-secondary leading-snug self-center">
