...
<!-- 
  ...
  <div class="relative isolate flex rounded-t-xl items-center gap-x-6 overflow-hidden bg-gray-700 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          <p class="text-sm leading-6 text-gray-300 font-medium">We stand with Palestine and human rights. Help Provide Humanitarin Aid to Palestine.</p>
          <a href="#" target="_blank" class="flex-none rounded-full bg-gray-100 px-3.5 py-1 text-sm  text-gray-800 shadow-sm hover:bg-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900 transition-all ease-in-out duration-500">Donate<span aria-hidden="true"> →</span>
          </a>
      </div>
      <div class="flex flex-1 justify-end -m-3 p-3">
          <button type="button" class="focus-visible:outline-offset-[-4px] p-.5 hover:bg-[#ffffff10] rounded-full transition-all ease-in-out duration-500">
...
export default SimpleBannerDark;
