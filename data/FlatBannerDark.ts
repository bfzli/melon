const FlatBannerDark = `
  ...
  <div class="absolute rounded-t-xl top-0 start-0 z-50 flex justify-between w-full p-4 border-b bg-gray-700 border-gray-600">
    <div class="flex items-center mx-auto">
        <p class="flex items-center text-sm font-normal text-gray-400">
            ...
            <span class="ml-2">We stand with Palestine and human rights. Help Provide Humanitarin Aid to Palestine. <a target="_blank" href="#" class="inline font-medium text-blue-500 underline hover:text-blue-400 decoration-600 decoration-solid transition-all ease-in-out duration-500">Donate</a>
            </span>
        </p>
    </div>
